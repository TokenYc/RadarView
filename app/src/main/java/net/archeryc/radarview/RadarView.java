...
public class RadarView extends View {
    ...
    private void startAnimator(final Canvas canvas) {
        ...
        for (int i=0;i<CIRCLE_NUM;i++){
            ...
            circleAnimators[i] = ObjectAnimator
                    .ofFloat(canvas, "yc", circleRadius[i] / 3.5f, getMeasuredWidth()/(2+(float)i*i*i/4))
                    .setDuration(1400);
